...
urlpatterns = [
    ...
    path('api/reports/quarterly/', views.quarterly_report_api_view, name='quarterly-report-api'),
    ...
    path('quarterly-report/', views.quarterly_report_page, name='quarterly-report-page'),
